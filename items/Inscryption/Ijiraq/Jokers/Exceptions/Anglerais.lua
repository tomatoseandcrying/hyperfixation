                                    ...
                                    func = function()
                                        ...
                                        if m_hand then
                                            for _, v in pairs(G.P_CENTER_POOLS.Planet) do
                                                if v.config.hand_type == m_hand then m_planet = v.key end
                                            end
                                        end
                            ...
                            func = (function()
                                ...
                                G.E_MANAGER:add_event(Event({
                                    func = function()
                                        ...
                                        for i = 1, #nonchicwheel do
                                            hpfx_temp_unban(nonchicwheel[i])
                                        end
                                        return true
                                    end
                                }))
                    ...
                    func = function()
                        G.E_MANAGER:add_event(Event({
                            func = (function()
                                ...
                                for i = 1, #nonchicwindow do
                                    hpfx_temp_unban(nonchicwindow[i])
                                end
                                return true
                            end)
                        }))
                            ...
                            func = (function()
                                ...
                                G.E_MANAGER:add_event(Event({
                                    func = function()
                                        ...
                                        for i = 1, #nonchicpillar do
                                            hpfx_temp_unban(nonchicpillar[i])
                                        end
                                        return true
                                    end
                                }))
